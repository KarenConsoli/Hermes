...
#End Region
    ...
    Private Sub ChoferToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tschofer220.Click
        ...
        Dim pantalla As New Choferes(_usuario, _idioma)
        pantalla.MdiParent = Me
        pantalla.Show()
    ...
    Private Sub BajaToolStripMenuItem_Click(sender As Object, e As EventArgs)
        ...
        Dim pantalla As New envios(_usuario, _idioma)
        pantalla.MdiParent = Me
        pantalla.Show()
    End Sub
    ...
    Private Sub ChoquesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tschoque510.Click
    ...
    Private Sub InformaciónEstadísticaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tsinfo.Click
        tsinfo.ForeColor = Color.Black
    ...
    Private Sub TransportesHistóricosToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles tstranshist530.Click
        contranshistorico.Show()

    End Sub

    Private Sub TransporToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tsbajasclientes521.Click
    ...
    Private Sub ChoquesToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles tsbajaschoques522.Click
        Dim pantalla As New conbajascrash(_usuario, _idioma)
        pantalla.MdiParent = Me
        pantalla.Show()
    End Sub

    Private Sub PauetesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tsbajaspaquetes523.Click
    ...
    Private Sub RodadosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tsbajasrodados524.Click
    ...
    Private Sub TransportesHistóricosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tsbajastransportes525.Click
    ...
    Private Sub BajasToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tsbajas.Click
    ...
    Private Sub AsginarChoferARodadoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tschofrod.Click


    End Sub

    Private Sub AsignarToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tschofrodasignar241.Click


    End Sub

    Private Sub VerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles tschofrodver242.Click
