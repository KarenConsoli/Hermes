...
#End Region
    ...
    Private Sub AceptarBtn_Click(sender As Object, e As EventArgs) Handles AceptarBtn.Click
        ...
        Dim seto As New DataSet
        seto = BLL.clsbuscar.actualizargrilla(seto, "punto_partida")
        ...
        BLL.clsbuscar.actualizar_datos(seto, "punto_partida")
        Dim dv As New BLL.blldv
        dv.recalcular_dvh("punto_partida")
        dv.Recalcular_dvv("punto_partida")


        Dim bita As New BLL.bllbitacora
        bita.usuario = _usuario
        bita.criticidad = "bajo"
        bita.desc_mov = "Lugar Partida Agregado"
        bita.grabar()
